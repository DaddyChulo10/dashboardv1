...
$query = mysqli_query($conexion, "SELECT * FROM m7_ventas WHERE id = '$_POST[id]'");
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-4">
                <table class="table table-striped">
                    ...
                    <tr>
                        <td>
                            <p><?php echo $row['folio'] ?>/<?php echo $fecha ?></p>
                        </td>
                    </tr>
                </table>
        ...
        <div class="row">
            <div class="col-5">
                ...
                <strong>Contacto: </strong><?php echo $row['contacto'] ?><br>
                <strong>Teléfono: </strong><?php echo $row['telefono'] ?><br>
                <strong>Email: </strong> <?php echo $row['correo'] ?>
            </div>
            <div class="col-4">
            ...
            <div class="col-3">
                ...
                <strong>Estatus: </strong> <?php echo $row['estatus'] ?>
            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>PZA</td>
                                <td><?php echo $row['1_nombre']; ?></td>
                                <td>
                                    <?php
                                    if (isset($_POST['modelo-ocul'])) {
                                        echo '';
                                    } else {
                                        echo $row['1_modelo'];
                                    }
                                ...
                                <td>
                                    <?php
                                    if (isset($_POST['descripcion-ocul']) && $_POST['descripcion-ocul'] != '') {
                                        echo $_POST['descripcion-ocul'];
                                    } else {
                                        echo $row['1_descripcion'];
                                    }
